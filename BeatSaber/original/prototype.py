...
class network(nn.Module):
    def __init__(self):
        ...
        self.conv9 = nn.Conv2d(10, 10, (2,1), 2)
        self.conv10 = nn.Conv2d(10, 10, (2,1), 2)
        self.fc1 = nn.Linear(850, 600)
        self.fc2 = nn.Linear(600, 500) 
        self.fc3 = nn.Linear(500, 441)
...
class audio(Dataset):
    ...
    def __getitem__(self, index):
        ...
        with open(file, 'rb') as f:
                ...
                label = sample['label']
                #return (torch.tensor(np.expand_dims(window, axis=0)).float(), torch.tensor(np.expand_dims(label, axis=0)))
